        ...
        <div class="intro" style="padding-left: 8%;">
          ...
          <div class="text-center bg-faded bg-custom p-5 col-md-11 rounded" style="">
            <div class="row" >
              ...
              <div class="container">
                <div class="intro">
                  <img class="intro-img img-fluid mb-3 mb-lg-0 rounded" src="<?php echo base_url('themes/img/home.jpg'); ?>" 
                  alt="">
                  <div class="intro-text left-0 text-center bg-faded p-5 rounded">
                    <h2 class="section-heading mb-4">Enjoy the serene sensation</h2>
                    <p class="mb-3">Start the day with great taste</p>
            ...
            <div class="">
              <div class="col-xl-13 mx-auto cta">
